...
Updates the app version in the specified Helm values file and creates a PR.
...
| <a name="input_base_branch"></a>[base_branch](#input_base_branch) | string |  false   | `"main"` |                       Base branch for the PR                        |
